    ...
    return (
        <div className="w-full">
            <div className="w-full bg-gray-800 flex justify-center">
                <div className="max-w-7xl w-full mx-2">
                    <div className="flex flex-row justify-start items-center py-2">
                        ...
                        <Link href="/">
                            <a className="ml-3 text-white text-2xl font-bold hover:text-yellow-300 hover:scale-105">
                                Fishes Of Change
                            </a>
                        </Link>
                    </div>
            ...
            <div className="w-full bg-blue-400 flex justify-center">
                <div className="flex justify-end max-w-7xl w-full mx-2 py-2 ">
                    <ul className="flex flex-row space-x-5 text-white font-bold">
                        <li>
                            <Link href="/">
